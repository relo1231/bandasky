        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-9 items-center justify-between">
            ...
            <div className="flex items-center gap-6 text-xs text-slate-500">
              <a href="mailto:info@bandasky.sk" className="flex items-center gap-1.5 transition-colors hover:text-emerald-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                </svg>
                info@bandasky.sk
              </a>
              <a href="tel:+421900000000" className="flex items-center gap-1.5 transition-colors hover:text-emerald-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center gap-1 sm:flex">
              ...
              <div className="ml-4 flex items-center gap-3 border-l border-slate-200 pl-4">
                <Link
                  href="/kosik"
                  className="relative flex items-center gap-2 rounded-lg border border-slate-200 px-4 py-2 font-heading text-sm font-semibold uppercase tracking-widest text-slate-600 transition-all hover:border-emerald-600 hover:text-emerald-700"
                >
                ...
                <Link
                  href="/produkty"
                  className="rounded-lg bg-emerald-600 px-5 py-2.5 font-heading text-sm font-bold uppercase tracking-widest text-white shadow-sm transition-all hover:bg-emerald-700 hover:shadow-md"
                >
                  Pozrieť nádrže
                </Link>
              </div>
          ...
          <div className="border-t border-slate-100 bg-white sm:hidden">
            <div className="space-y-1 px-4 py-3">
              ...
              <Link
                href="/kosik"
                onClick={() => setOpen(false)}
                className="block rounded-lg bg-emerald-600 px-3 py-2.5 font-heading text-sm font-bold uppercase tracking-widest text-white"
              >
                Dopyt ({pocetPoloziek})
              </Link>
            </div>
